...
\begin{equation}
	...
	E \equiv E(\Ekin) = \frac{1}{2} m_\elecIndex \beta(\Ekin, m_\elecIndex)^2
\end{equation}
with $\beta$ as in equation~\eqref{eq:eDepScatCrossSecSourcesCrossSecBetaFactor}. Figure~\ref{fig:eDepScatCrossSecSourcesValues} shows the theoretical cross-section formula~\eqref{eq:eDepScatCrossSecSourcesCrossSecLiu} along with the measured value by the Troitsk experiment and the value from the KATRIN Design Report.
\begin{figure}[t]
	\centering
