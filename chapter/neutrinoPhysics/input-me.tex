...
\section{Mechanisms to generate Neutrino Masses}
...
\begin{table}
	\xcaption{Constraining the neutrino mass by double-$\upbeta$ decay experiments}{Constraining the neutrino mass by double-$\upbeta$ decay experiments.}{Listed are the two most stringent limits on $m_{\upbeta\upbeta}$, equation~\ref{eq:majoranaMass}, given as ranges.}
\begin{center}
	\begin{tabular}{llr}
		\toprule
...
\begin{table}
	\centering
	\xcaption{Neutrino mass constraints from kinematic measurements}{Neutrino mass constraints from kinematic measurements.}{The table lists upper limits on the absolute neutrino masses for different neutrino flavors.}
