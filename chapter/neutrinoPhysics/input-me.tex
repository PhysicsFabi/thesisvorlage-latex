...
\begin{table}
	\xcaption{Constrains on the neutrino mass by double-$\upbeta$ decay experiments}{Constrains on the neutrino mass by double-$\boldsymbol{\upbeta}$ decay experiments.}{Listed are the two most stringent limits on $m_{\upbeta\upbeta}$ (eq.~\ref{eq:majoranaMass}) given as ranges.}
\begin{center}
	\begin{tabular}{llr}
		\toprule
