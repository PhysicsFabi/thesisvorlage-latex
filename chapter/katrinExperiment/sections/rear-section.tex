...
\begin{figure}[t]
    \inputpdftex{\currentFigureFolder/rear-section}
   	\xcaption{KATRIN rear section (RS)}{The rear section (RS)}{terminates the KATRIN beam line and houses several monitoring and calibration devices that are described in the main text. (Adapted from~\cite{SeitzM2019}.)}
