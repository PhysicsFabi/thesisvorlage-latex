...
This section explains the origin of the often quoted KATRIN design sensitivity to the neutrino mass of $\SI{200}{meV}$\,(\SI{90}{\percent} C.L.).
...
\end{equation}
Adding these two quadratically yields KATRIN's sensitivity~\cite{Angrik:2005ep}
\begin{equation}
...
\begin{table}[ht]
	...
	\begin{tabular}{lrlr}
		...
		$0.0162\pm0.0001$ & 197 & updated $\upbeta$-spectrum calculation & \cite{Kleesiek2014} \\
