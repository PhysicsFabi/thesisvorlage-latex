...
Table~\ref{tab:SMGaugeFields} contains the \gls{standardmodel}'s corresponding gauge fields and their associated charges. The B- and W-fields mix to the observable \ce{W^+}, \ce{W^-} and \ce{Z^0} bosons as well as to the photon $\upgamma$. Table~\ref{tab:SMMatterFields} contains the \gls{standardmodel}'s matter fields and their properties.

\begin{table}[tb]
	\xcaption{Gauge field content of the Standard Model}{Gauge field content of the Standard Model.}{Hello WOrlds}
	\centering
	\begin{tabular}{lrl}
		\toprule
