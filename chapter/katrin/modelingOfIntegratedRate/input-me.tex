\input{chapter/katrin/modelingOfIntegratedRate/symbols.tex}
...
\begin{itemize}
    ...
    \item \textbf{Background events:} Background events can be modelled by adding to the counts $N$ \eqref{eq:nonAveragedCounts}.
