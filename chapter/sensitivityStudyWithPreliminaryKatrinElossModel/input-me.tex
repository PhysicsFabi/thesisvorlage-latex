...
\end{figure}
The KATRIN energy was established by a dedicated subgroup of the KATRIN collaboration. It is partly of empirical nature and partly based on first principles. The model was fitted to data taken at the KATRIN experiment in October 2018. A description and a parametrization is given in the following.
...
\def\currentFigureFolder{\currentRootFolder/fig}
\FloatBarrier
\section{Deduced Sensitivity on the Neutrino Mass}
