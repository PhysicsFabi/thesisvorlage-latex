...
\end{figure}
\FloatBarrier
\section{Mitigation of Systematic Effects by Free Fit Parameters}
...
\begin{table}[t]
	\centering
	\xcaption{Systematic shifts of the squared neutrino mass induced by offsets of the parameters of the preliminary KATRIN energy loss model}{Systematic shifts of the squared neutrino mass induced by offsets of the parameters of the preliminary KATRIN energy loss model.}{The left column lists all parameters of the KATRIN energy loss model. Each one was displaced from its mean value by its uncertainty in a separate simulation. The difference of the inferred squared neutrino mass from the simulation truth is given in the two central columns. The sub columns show the shift for a negatively or a positively displaced parameter, respectively. The study was done once for fixed parameters of the KATRIN energy loss model and once with having them as free fit parameters as described in the main text. The last column shows by which quantity the free fit parameters can compensate for the systematic shift.}
