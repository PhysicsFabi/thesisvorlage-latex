...
\DeclareFieldFormat[online, thesis]{date}{\mkbibparens{#1}}
\DeclareFieldFormat[unpublished]{note}{#1,}
...
\addbibresource{chapter/sensitivityStudyWithPreliminaryKatrinElossModel/lit.bib}
